...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:rfrMWQ87lhd8EzQWRnbQ4gXrniL/yTRBgYH1x1+BLlo=",
        version = "v0.20.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:lGno2t3gcZnLtzsKH4oG0xA9/4GTiBzMO1DGp+K+Bak=",
        version = "v0.20.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:LMmu5I0pLtwjpp5009KLuMGFqSc2S2isGw8t1hpYKLE=",
        version = "v0.20.2",
    )
    go_repository(
        name = "io_k8s_gengo",
    ...
    go_repository(
        ...
        sum = "h1:SBWmI0b3uzMIUD/BIXWNegrCeZmPJ503pOtwxY0LPHM=",
        version = "v0.8.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:IT//rvmLbxuLQ4WUkcP3TXU6CGC2xSMCNgwALW6WAds=",
        version = "v0.0.0-20210225234839-9dfe677337d5",
    )
    go_repository(
